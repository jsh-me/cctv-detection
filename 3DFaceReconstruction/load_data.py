...
class BFM():
	def __init__(self):
		model_path = '/content/gdrive/My Drive/darknet/data/3DFaceReconstruction/BFM/BFM_model_front.mat'
...
def LoadExpBasis():
	n_vertex = 53215
	Expbin = open('/content/gdrive/My Drive/darknet/data/3DFaceReconstruction/BFM/Exp_Pca.bin','rb')
	exp_dim = array('i')
	...
	expEV = np.loadtxt('/content/gdrive/My Drive/darknet/data/3DFaceReconstruction/BFM/std_exp.txt')

	return expPC,expEV

# transfer original BFM09 to our face model
def transferBFM09():
	original_BFM = loadmat('/content/gdrive/My Drive/darknet/data/3DFaceReconstruction/BFM/01_MorphableModel.mat')
	...
	index_exp = loadmat('/content/gdrive/My Drive/darknet/data/3DFaceReconstruction/BFM/BFM_front_idx.mat')
	index_exp = index_exp['idx'].astype(np.int32) - 1 #starts from 0 (to 53215)

	index_shape = loadmat('/content/gdrive/My Drive/darknet/data/3DFaceReconstruction/BFM/BFM_exp_idx.mat')
	...
	other_info = loadmat('/content/gdrive/My Drive/darknet/data/3DFaceReconstruction/BFM/facemodel_info.mat')
	...
	# save our face model
	savemat('/content/gdrive/My Drive/darknet/data/3DFaceReconstruction/BFM/BFM_model_front.mat',{'meanshape':meanshape,'meantex':meantex,'idBase':idBase,'exBase':exBase,'texBase':texBase,'tri':tri,'point_buf':point_buf,'tri_mask2':tri_mask2\
...
# 원본 load landmarks for standard face, which is used for image preprocessing
def load_lm3d():

	Lm3D = loadmat('/content/gdrive/My Drive/darknet/data/3DFaceReconstruction/BFM/similarity_Lm3D_all.mat')
	Lm3D = Lm3D['lm']

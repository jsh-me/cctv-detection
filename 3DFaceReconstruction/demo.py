...
def demo():
	...
	if not os.path.isfile('/content/gdrive/My Drive/darknet/data/3DFaceReconstruction/BFM/BFM_model_front.mat'):
		transferBFM09()
	...
	with tf.Graph().as_default() as graph,tf.device('/cpu:0'):
		...
		graph_def = load_graph('/content/gdrive/My Drive/darknet/data/3DFaceReconstruction/network/FaceReconModel.pb')
